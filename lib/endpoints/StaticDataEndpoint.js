...
class StaticDataEndpoint extends Endpoint {
	...
	gettingChampions(platformIdOrRegion, options = {}) {
		...
		return this.executingRequest(`/champions`, _platformId, _options);
	}
	...
	gettingChampionById(championId, platformIdOrRegion, options = {}) {
		...
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/champions/${championId}`, _platformId, _options);
	}
	...
	gettingItems(platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/items`, _platformId, _options);
	}
	...
	gettingItemById(itemId, platformIdOrRegion, options = {}) {
		...
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/items/${itemId}`, _platformId, _options);
	}
	...
	gettingLanguageStrings(platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/language-strings`, _platformId, _options);
	}
	...
	gettingMaps(platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/maps`, _platformId, _options);
	}
	...
	gettingMasteries(platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/masteries`, _platformId, _options);
	}
	...
	gettingMasteryById(masteryId, platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/masteries/${masteryId}`, _platformId, _options);
	}
	...
	gettingProfileIcons(platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/profile-icons`, _platformId, _options);
	}
	...
	gettingRunes(platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/runes`, _platformId, _options);
	}
	...
	gettingRunesById(runeId, platformIdOrRegion, options = {}) {
		...
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/runes/${runeId}`, _platformId, _options);
	}
	...
	gettingSummonerSpells(platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/summoner-spells`, _platformId, _options);
	}
	...
	gettingSummonerSpellsById(summonerSpellId, platformIdOrRegion, options = {}) {
		const {_platformId, _options} = ParameterUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
		return this.executingRequest(`/summoner-spells/${summonerSpellId}`, _platformId, _options);
	}
