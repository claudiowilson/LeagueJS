...
class StaticDataEndpoint extends Endpoint {
	 ...
	 */
	gettingChampions(platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingChampionById(championId, platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
	 ...
	 */
	gettingItems(platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingItemById(itemId, platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
	 ...
	 */
	gettingLanguageStrings(platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingMaps(platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingMasteries(platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingMasteryById(masteryId, platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingProfileIcons(platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingRunes(platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingRunesById(runeId, platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
	 ...
	 */
	gettingSummonerSpells(platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
	 ...
	 */
	gettingSummonerSpellsById(summonerSpellId, platformIdOrRegion = this.config.PLATFORM_ID, options = {}) {
		const {_platformId, _options} = EndpointUtil.extractPlatformIdAndOptions(platformIdOrRegion, options);
