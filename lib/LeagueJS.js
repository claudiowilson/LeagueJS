...
class LeagueJS extends LeagueUtil{
	...
	constructor(options = {}) {
		...
		this.ChampionMastery = new ChampionMasteryEndpoint(this.config, LeagueUtil.getPlatformIds());
		this.Champion = new ChampionEndpoint(this.config, LeagueUtil.getPlatformIds());
		this.League = new LeagueEndpoint(this.config, LeagueUtil.getPlatformIds());
		this.LolStatus = new LolStatusEndpoint(this.config, LeagueUtil.getPlatformIds());
		this.Masteries = new MasteriesEndpoint(this.config, LeagueUtil.getPlatformIds());
		this.Match = new MatchEndpoint(this.config, LeagueUtil.getPlatformIds());
		this.Runes = new RunesEndpoint(this.config, LeagueUtil.getPlatformIds());
		this.Spectator = new SpectatorEndpoint(this.config, LeagueUtil.getPlatformIds());
