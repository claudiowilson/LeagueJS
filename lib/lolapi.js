...
(function () {
    ...
    League.Static.getChampionList = function(options, regionOrFunction, callback) {
        ...
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
        url = util.craftUrl(endpoint + '/static-data', regionAndFunc.region, championListUrl + '&', authKey);
    ...
    League.Static.getItemList = function(options, regionOrFunction, callback) {
        ...
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
        url = util.craftUrl(endpoint + '/static-data', regionAndFunc.region, itemListUrl + '&', authKey);
    ...
    League.Static.getMasteryList = function(options, regionOrFunction, callback) {
        ...
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
        url = util.craftUrl(endpoint + '/static-data', regionAndFunc.region, masteryListUrl + '&', authKey);
    ...
    League.Static.getMasteryById = function(id, options, regionOrFunction, callback) {
        ...
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
        url = util.craftUrl(endpoint + '/static-data', regionAndFunc.region, masteryIdUrl + '&', authKey);
    ...
    League.Static.getRealm = function(regionOrFunction, callback) {
        ...
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
        url = util.craftUrl(endpoint + '/static-data', regionAndFunc.region, realmUrl + '&', authKey);
    ...
    League.Static.getRuneList = function(options, regionOrFunction, callback) {
        ...
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
        url = util.craftUrl(endpoint + '/static-data', regionAndFunc.region, runeListUrl + '&', authKey);
    ...
    League.Static.getSummonerSpellList = function(options, regionOrFunction, callback) {
        ...
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
        url = util.craftUrl(endpoint + '/static-data', regionAndFunc.region, summonerSpellUrl + '&', authKey);
        util.makeRequest(url, 'Error getting summoner spell list : ', null, regionAndFunc.callback);
    };

    League.Static.getSummonerSpellById = function(options, regionOrFunction, callback) {
    ...
    League.Static.getVersions = function(regionOrFunction, callback) {
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
        url = util.craftUrl(endpoint + '/static-data', regionAndFunc.region, '/v1.2/versions?', authKey);
